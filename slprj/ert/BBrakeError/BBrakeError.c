 ...
 * C/C++ source code generated on : Wed Jun  3 14:54:20 2026
 *
...
void BBrakeError(const real_T *rtu_pBrakeF, const real_T *rtu_pBrakeR, boolean_T
                 ...
                 *localDW)
{
   ...
   *  MinMax: '<S2>/Max'
   */
  tmp = fmax(*rtu_pBrakeF, *rtu_pBrakeR);
   ...
   */
  *rty_BBrakeError = ((fmin(*rtu_pBrakeF, *rtu_pBrakeR) < -10.0) || (tmp > 150.0));
