 ...
 * C/C++ source code generated on : Tue Jun  2 18:46:02 2026
 *
...
void BBrakeLight(const boolean_T *rtu_BBrakeOn, const real_T
                 *rtu_gLongitudinalOXTSIMU, const real_T *rtu_vChassis,
                 boolean_T *rty_BBrakeLight)
{
  boolean_T tmp;
   ...
   */
  if (*rtu_vChassis > 5.0) {
    tmp = (*rtu_gLongitudinalOXTSIMU <= -4.0);
  } else {
    tmp = (*rtu_gLongitudinalOXTSIMU <= -0.7);
  }
