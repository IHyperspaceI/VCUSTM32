###########################################################################
## Makefile generated for component 'PowerController'. 
## 
## Makefile     : PowerController.mk
## Generated on : Tue Sep 08 13:40:19 2026
## Final product: ./PowerController_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PowerController_comp.rsp
CMD_FILE                  = PowerController.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PowerController_rtwlib.lib
...
PRODUCT = ./PowerController_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PowerController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PowerController/PowerController.c
...
%.o : $(START_DIR)/slprj/ert/PowerController/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PowerController/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PowerController/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PowerController/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PowerController/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PowerController.o : $(START_DIR)/slprj/ert/PowerController/PowerController.c
	$(CC) $(CFLAGS) -o "$@" "$<"
