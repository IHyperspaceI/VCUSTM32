###########################################################################
## Makefile generated for component 'BPedalOverlap'. 
## 
## Makefile     : BPedalOverlap.mk
## Generated on : Tue Sep 08 13:39:13 2026
## Final product: ./BPedalOverlap_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BPedalOverlap_comp.rsp
CMD_FILE                  = BPedalOverlap.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BPedalOverlap_rtwlib.lib
...
PRODUCT = ./BPedalOverlap_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BPedalOverlap -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BPedalOverlap/BPedalOverlap.c
...
%.o : $(START_DIR)/slprj/ert/BPedalOverlap/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BPedalOverlap/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BPedalOverlap/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BPedalOverlap/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BPedalOverlap/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BPedalOverlap.o : $(START_DIR)/slprj/ert/BPedalOverlap/BPedalOverlap.c
	$(CC) $(CFLAGS) -o "$@" "$<"
