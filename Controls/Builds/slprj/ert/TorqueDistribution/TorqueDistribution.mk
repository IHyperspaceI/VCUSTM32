###########################################################################
## Makefile generated for component 'TorqueDistribution'. 
## 
## Makefile     : TorqueDistribution.mk
## Generated on : Tue Sep 08 13:40:29 2026
## Final product: ./TorqueDistribution_rtwlib.lib
...
PRODUCT_NAME              = TorqueDistribution
MAKEFILE                  = TorqueDistribution.mk
...
COMPILER_COMMAND_FILE     = TorqueDistribution_comp.rsp
CMD_FILE                  = TorqueDistribution.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TorqueDistribution_rtwlib.lib
...
PRODUCT = ./TorqueDistribution_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=TorqueDistribution -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/TorqueDistribution/TorqueDistribution.c
...
%.o : $(START_DIR)/slprj/ert/TorqueDistribution/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TorqueDistribution/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TorqueDistribution/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TorqueDistribution/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TorqueDistribution/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TorqueDistribution.o : $(START_DIR)/slprj/ert/TorqueDistribution/TorqueDistribution.c
	$(CC) $(CFLAGS) -o "$@" "$<"
