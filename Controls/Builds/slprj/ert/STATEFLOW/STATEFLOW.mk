###########################################################################
## Makefile generated for component 'STATEFLOW'. 
## 
## Makefile     : STATEFLOW.mk
## Generated on : Tue Sep 08 13:40:56 2026
## Final product: ./STATEFLOW_rtwlib.lib
...
MODELREF_LINK_RSPFILE     = STATEFLOW_ref.rsp
COMPILER_COMMAND_FILE     = STATEFLOW_comp.rsp
CMD_FILE                  = STATEFLOW.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = STATEFLOW_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=STATEFLOW -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/STATEFLOW/STATEFLOW.c
...
MODELREF_LIBS = ../../../slprj/ert/NBMSState/NBMSState_rtwlib.lib ../../../slprj/ert/NCarState/NCarState_rtwlib.lib ../../../slprj/ert/NInvState/NInvState_rtwlib.lib
...
%.o : $(START_DIR)/slprj/ert/STATEFLOW/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/STATEFLOW/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/STATEFLOW/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/STATEFLOW/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/STATEFLOW/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
STATEFLOW.o : $(START_DIR)/slprj/ert/STATEFLOW/STATEFLOW.c
	$(CC) $(CFLAGS) -o "$@" "$<"
