###########################################################################
## Makefile generated for component 'MFinal'. 
## 
## Makefile     : MFinal.mk
## Generated on : Tue Sep 08 13:40:12 2026
## Final product: ./MFinal_rtwlib.lib
...
COMPILER_COMMAND_FILE     = MFinal_comp.rsp
CMD_FILE                  = MFinal.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MFinal_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MFinal -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MFinal/MFinal.c
...
%.o : $(START_DIR)/slprj/ert/MFinal/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MFinal/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MFinal/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MFinal/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MFinal/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MFinal.o : $(START_DIR)/slprj/ert/MFinal/MFinal.c
	$(CC) $(CFLAGS) -o "$@" "$<"
