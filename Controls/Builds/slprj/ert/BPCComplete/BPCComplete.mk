###########################################################################
## Makefile generated for component 'BPCComplete'. 
## 
## Makefile     : BPCComplete.mk
## Generated on : Tue Sep 08 13:39:10 2026
## Final product: ./BPCComplete_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BPCComplete_comp.rsp
CMD_FILE                  = BPCComplete.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BPCComplete_rtwlib.lib
...
PRODUCT = ./BPCComplete_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BPCComplete -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BPCComplete/BPCComplete.c
...
%.o : $(START_DIR)/slprj/ert/BPCComplete/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BPCComplete/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BPCComplete/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BPCComplete/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BPCComplete/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BPCComplete.o : $(START_DIR)/slprj/ert/BPCComplete/BPCComplete.c
	$(CC) $(CFLAGS) -o "$@" "$<"
