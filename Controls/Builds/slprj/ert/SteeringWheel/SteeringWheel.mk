###########################################################################
## Makefile generated for component 'SteeringWheel'. 
## 
## Makefile     : SteeringWheel.mk
## Generated on : Tue Sep 08 13:39:35 2026
## Final product: ./SteeringWheel_rtwlib.lib
...
COMPILER_COMMAND_FILE     = SteeringWheel_comp.rsp
CMD_FILE                  = SteeringWheel.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = SteeringWheel_rtwlib.lib
...
PRODUCT = ./SteeringWheel_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=SteeringWheel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/SteeringWheel/SteeringWheel.c
...
%.o : $(START_DIR)/slprj/ert/SteeringWheel/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/SteeringWheel/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/SteeringWheel/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/SteeringWheel/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/SteeringWheel/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SteeringWheel.o : $(START_DIR)/slprj/ert/SteeringWheel/SteeringWheel.c
	$(CC) $(CFLAGS) -o "$@" "$<"
