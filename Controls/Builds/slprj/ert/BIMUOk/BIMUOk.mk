###########################################################################
## Makefile generated for component 'BIMUOk'. 
## 
## Makefile     : BIMUOk.mk
## Generated on : Tue Sep 08 13:39:05 2026
## Final product: ./BIMUOk_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BIMUOk_comp.rsp
CMD_FILE                  = BIMUOk.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BIMUOk_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BIMUOk -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BIMUOk/BIMUOk.c
...
%.o : $(START_DIR)/slprj/ert/BIMUOk/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BIMUOk/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BIMUOk/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BIMUOk/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BIMUOk/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BIMUOk.o : $(START_DIR)/slprj/ert/BIMUOk/BIMUOk.c
	$(CC) $(CFLAGS) -o "$@" "$<"
