###########################################################################
## Makefile generated for component 'MTotalRequested'. 
## 
## Makefile     : MTotalRequested.mk
## Generated on : Tue Sep 08 13:40:15 2026
## Final product: ./MTotalRequested_rtwlib.lib
...
COMPILER_COMMAND_FILE     = MTotalRequested_comp.rsp
CMD_FILE                  = MTotalRequested.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MTotalRequested_rtwlib.lib
...
PRODUCT = ./MTotalRequested_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MTotalRequested -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MTotalRequested/MTotalRequested.c
...
%.o : $(START_DIR)/slprj/ert/MTotalRequested/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MTotalRequested/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MTotalRequested/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MTotalRequested/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MTotalRequested/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MTotalRequested.o : $(START_DIR)/slprj/ert/MTotalRequested/MTotalRequested.c
	$(CC) $(CFLAGS) -o "$@" "$<"
