###########################################################################
## Makefile generated for component 'PEnergyMeter'. 
## 
## Makefile     : PEnergyMeter.mk
## Generated on : Tue Sep 08 13:39:26 2026
## Final product: ./PEnergyMeter_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PEnergyMeter_comp.rsp
CMD_FILE                  = PEnergyMeter.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PEnergyMeter_rtwlib.lib
...
PRODUCT = ./PEnergyMeter_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PEnergyMeter -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PEnergyMeter/PEnergyMeter.c
...
%.o : $(START_DIR)/slprj/ert/PEnergyMeter/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PEnergyMeter/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PEnergyMeter/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PEnergyMeter/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PEnergyMeter/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PEnergyMeter.o : $(START_DIR)/slprj/ert/PEnergyMeter/PEnergyMeter.c
	$(CC) $(CFLAGS) -o "$@" "$<"
