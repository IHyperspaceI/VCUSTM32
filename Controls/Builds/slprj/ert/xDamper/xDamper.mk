###########################################################################
## Makefile generated for component 'xDamper'. 
## 
## Makefile     : xDamper.mk
## Generated on : Tue Sep 08 13:39:59 2026
## Final product: ./xDamper_rtwlib.lib
...
COMPILER_COMMAND_FILE     = xDamper_comp.rsp
CMD_FILE                  = xDamper.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = xDamper_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=xDamper -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/xDamper/xDamper.c
...
%.o : $(START_DIR)/slprj/ert/xDamper/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/xDamper/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/xDamper/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/xDamper/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/xDamper/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
xDamper.o : $(START_DIR)/slprj/ert/xDamper/xDamper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
