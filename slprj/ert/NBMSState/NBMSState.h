 ...
 * C/C++ source code generated on : Tue Jun  2 18:45:28 2026
 *
...
typedef struct {
  uint16_T temporalCounter_i1;         /* '<Root>/NBMSStatus System' */
  uint8_T is_active_c3_NBMSState;      /* '<Root>/NBMSStatus System' */
  uint8_T is_c3_NBMSState;             /* '<Root>/NBMSStatus System' */
} DW_NBMSState_f_T;
...
extern void NBMSState(const boolean_T *rtu_BBMSP0A0C, const boolean_T
                      ...
                      *rtu_RCellAverage, const boolean_T *rtu_BBalancingActive,
                      const real_T *rtu_VCellAverage, real_T *rty_NBMSState,
 ...
 *
 * '<Root>' : 'NBMSState'
 * '<S1>'   : 'NBMSState/NBMSStatus System'
 */
#endif                                 /* NBMSState_h_ */
