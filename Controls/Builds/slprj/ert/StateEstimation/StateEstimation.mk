###########################################################################
## Makefile generated for component 'StateEstimation'. 
## 
## Makefile     : StateEstimation.mk
## Generated on : Tue Sep 08 13:40:26 2026
## Final product: ./StateEstimation_rtwlib.lib
...
COMPILER_COMMAND_FILE     = StateEstimation_comp.rsp
CMD_FILE                  = StateEstimation.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = StateEstimation_rtwlib.lib
...
PRODUCT = ./StateEstimation_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=StateEstimation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/StateEstimation/StateEstimation.c $(START_DIR)/slprj/ert/StateEstimation/StateEstimation_data.c
...
OBJS = StateEstimation.o StateEstimation_data.o
...
%.o : $(START_DIR)/slprj/ert/StateEstimation/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/StateEstimation/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/StateEstimation/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/StateEstimation/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/StateEstimation/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
StateEstimation.o : $(START_DIR)/slprj/ert/StateEstimation/StateEstimation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


StateEstimation_data.o : $(START_DIR)/slprj/ert/StateEstimation/StateEstimation_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
