###########################################################################
## Makefile generated for component 'EMS'. 
## 
## Makefile     : EMS.mk
## Generated on : Tue Sep 08 13:40:03 2026
## Final product: ./EMS_rtwlib.lib
...
COMPILER_COMMAND_FILE     = EMS_comp.rsp
CMD_FILE                  = EMS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = EMS_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=EMS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/EMS/EMS.c
...
%.o : $(START_DIR)/slprj/ert/EMS/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/EMS/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/EMS/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/EMS/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
EMS.o : $(START_DIR)/slprj/ert/EMS/EMS.c
	$(CC) $(CFLAGS) -o "$@" "$<"
