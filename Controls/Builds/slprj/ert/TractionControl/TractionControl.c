 ...
 * C/C++ source code generated on : Tue Sep  8 11:43:44 2026
 *
                     ...
                     *localDW)
{
  ...
  *rty_rSlipRatioOptimal = rtb_Abs * rtb_Saturation1_idx_0;
  ...
  if (rtb_Gain_c > 1.2000000000000002) {
    u0_2 = localDW->PrevY[0] + 1.2000000000000002;
  } else if (rtb_Gain_c < -6.0) {
    u0_2 = localDW->PrevY[0] - 6.0;
  }
  ...
  *rty_NTractionControlPTermFL = u0_3;
  ...
  if (rtb_Gain_c > 1.2000000000000002) {
    u0_2 = localDW->PrevY[1] + 1.2000000000000002;
  } else if (rtb_Gain_c < -6.0) {
    u0_2 = localDW->PrevY[1] - 6.0;
  }
  ...
  *rty_NTractionControlPTermFR = u0_3;
  ...
  if (rtb_Gain_c > 1.2000000000000002) {
    u0_2 = localDW->PrevY[2] + 1.2000000000000002;
  } else if (rtb_Gain_c < -6.0) {
    u0_2 = localDW->PrevY[2] - 6.0;
  }
  ...
  *rty_NTractionControlPTermRL = u0_3;
  ...
  if (rtb_Gain_c > 1.2000000000000002) {
    u0_2 = localDW->PrevY[3] + 1.2000000000000002;
  } else if (rtb_Gain_c < -6.0) {
    u0_2 = localDW->PrevY[3] - 6.0;
  }
  ...
  if (rtb_Gain_c > 6.0) {
    Memory_PreviousInput_j = localDW->PrevY_f[0] + 6.0;
  } else if (rtb_Gain_c < -1.2000000000000002) {
    Memory_PreviousInput_j = localDW->PrevY_f[0] - 1.2000000000000002;
  }
  ...
  *rty_NABSDTermFL = Memory_PreviousInput_j;
  ...
  if (rtb_Gain_c > 6.0) {
    Memory_PreviousInput_j = localDW->PrevY_f[1] + 6.0;
  } else if (rtb_Gain_c < -1.2000000000000002) {
    Memory_PreviousInput_j = localDW->PrevY_f[1] - 1.2000000000000002;
  }
  ...
  *rty_NABSDTermFR = Memory_PreviousInput_j;
  ...
  if (rtb_Gain_c > 6.0) {
    Memory_PreviousInput_j = localDW->PrevY_f[2] + 6.0;
  } else if (rtb_Gain_c < -1.2000000000000002) {
    Memory_PreviousInput_j = localDW->PrevY_f[2] - 1.2000000000000002;
  }
  ...
  *rty_NABSDTermRL = Memory_PreviousInput_j;
  ...
  if (rtb_Gain_c > 6.0) {
    Memory_PreviousInput_j = localDW->PrevY_f[3] + 6.0;
  } else if (rtb_Gain_c < -1.2000000000000002) {
    Memory_PreviousInput_j = localDW->PrevY_f[3] - 1.2000000000000002;
  }
