###########################################################################
## Makefile generated for component 'TractionControl'. 
## 
## Makefile     : TractionControl.mk
## Generated on : Tue Sep 08 13:40:37 2026
## Final product: ./TractionControl_rtwlib.lib
...
COMPILER_COMMAND_FILE     = TractionControl_comp.rsp
CMD_FILE                  = TractionControl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TractionControl_rtwlib.lib
...
PRODUCT = ./TractionControl_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=TractionControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/TractionControl/TractionControl.c $(START_DIR)/slprj/ert/TractionControl/TractionControl_data.c
...
%.o : $(START_DIR)/slprj/ert/TractionControl/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TractionControl/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TractionControl/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TractionControl/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TractionControl/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TractionControl.o : $(START_DIR)/slprj/ert/TractionControl/TractionControl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TractionControl_data.o : $(START_DIR)/slprj/ert/TractionControl/TractionControl_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
