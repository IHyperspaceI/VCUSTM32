###########################################################################
## Makefile generated for component 'TractiveSystemTemperatures'. 
## 
## Makefile     : TractiveSystemTemperatures.mk
## Generated on : Tue Sep 08 13:39:38 2026
## Final product: ./TractiveSystemTemperatures_rtwlib.lib
...
PRODUCT_NAME              = TractiveSystemTemperatures
MAKEFILE                  = TractiveSystemTemperatures.mk
...
COMPILER_COMMAND_FILE     = TractiveSystemTemperatures_comp.rsp
CMD_FILE                  = TractiveSystemTemperatures.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TractiveSystemTemperatures_rtwlib.lib
...
PRODUCT = ./TractiveSystemTemperatures_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=TractiveSystemTemperatures -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/TractiveSystemTemperatures/TractiveSystemTemperatures.c
...
OBJS = TractiveSystemTemperatures.o
...
%.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TractiveSystemTemperatures.o : $(START_DIR)/slprj/ert/TractiveSystemTemperatures/TractiveSystemTemperatures.c
	$(CC) $(CFLAGS) -o "$@" "$<"
