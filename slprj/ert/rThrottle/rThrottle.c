 ...
 * C/C++ source code generated on : Fri Jul 31 17:34:37 2026
 *
               ...
               *rty_rThrottlePedal, DW_rThrottle_f_T *localDW)
{
  ...
  if (rateLimiterRate > 0.375) {
    *rty_rThrottlePedal = localDW->PrevY + 0.375;
  } else if (rateLimiterRate < -1.0) {
    *rty_rThrottlePedal = localDW->PrevY - 1.0;
  } else {
  ...
  *rty_rThrottlePedal2 = *rty_rThrottlePedal;
  ...
  if (rateLimiterRate > 0.375) {
    *rty_rThrottlePedal1 = localDW->PrevY_m + 0.375;
  } else if (rateLimiterRate < -1.0) {
    *rty_rThrottlePedal1 = localDW->PrevY_m - 1.0;
  } else {
