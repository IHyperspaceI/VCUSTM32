...
} DW_SPIControllerTransfer_Base_T;
...
} DW_SPIControllerTransfer1_Bas_T;
...
} DW_SPIControllerTransfer5_Bas_T;
...
typedef struct {
  ...
  DW_SPIControllerTransfer5_Bas_T SPIControllerTransfer7;/* '<S22>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer1_Bas_T SPIControllerTransfer6_p;/* '<S22>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer5_Bas_T SPIControllerTransfer5_p;/* '<S22>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer1_Bas_T SPIControllerTransfer4;/* '<S22>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_Bas_T SPIControllerTransfer3;/* '<S22>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_Bas_T SPIControllerTransfer2;/* '<S22>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_Bas_T SPIControllerTransfer1_p;/* '<S22>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer_Base_T SPIControllerTransfer6;/* '<S2>/SPI Controller Transfer' */
  DW_SPIControllerTransfer_Base_T SPIControllerTransfer;/* '<S2>/SPI Controller Transfer' */
  DW_MATLABFunction_Base_T sf_MATLABFunction4;/* '<S2>/MATLAB Function4' */
  DW_MATLABFunction_Base_T sf_MATLABFunction;/* '<S2>/MATLAB Function' */
} DW_Base_T;
...
/* External inputs (root inport signals with default storage) */
extern ExtU_Base_T Base_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_Base_T Base_Y;
 ...
 * '<S1>'   : 'Base/CAN Rx'
 * '<S2>'   : 'Base/CAN Tx20'
 * '<S3>'   : 'Base/Compare To Constant'
 * '<S4>'   : 'Base/Counter Limited'
 * '<S5>'   : 'Base/Digital Port Read1'
 * '<S6>'   : 'Base/Digital Port Write'
 * '<S7>'   : 'Base/Digital Port Write1'
 * '<S8>'   : 'Base/Subsystem'
 * '<S9>'   : 'Base/CAN Rx/MATLAB Function7'
 * '<S10>'  : 'Base/CAN Tx20/MATLAB Function'
 * '<S11>'  : 'Base/CAN Tx20/MATLAB Function4'
 * '<S12>'  : 'Base/Counter Limited/Increment Real World'
 * '<S13>'  : 'Base/Counter Limited/Wrap To Zero'
 * '<S14>'  : 'Base/Digital Port Read1/ECSoC'
 * '<S15>'  : 'Base/Digital Port Read1/ECSoC/ECSimCodegen'
 * '<S16>'  : 'Base/Digital Port Write/ECSoC'
 * '<S17>'  : 'Base/Digital Port Write/ECSoC/ECSimCodegen'
 * '<S18>'  : 'Base/Digital Port Write1/ECSoC'
 * '<S19>'  : 'Base/Digital Port Write1/ECSoC/ECSimCodegen'
 * '<S20>'  : 'Base/Subsystem/Detect Increase'
 * '<S21>'  : 'Base/Subsystem/Initialize'
 * '<S22>'  : 'Base/Subsystem/MCPInit'
 */
#endif                                 /* Base_h_ */
