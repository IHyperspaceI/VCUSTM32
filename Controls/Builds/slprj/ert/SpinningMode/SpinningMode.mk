###########################################################################
## Makefile generated for component 'SpinningMode'. 
## 
## Makefile     : SpinningMode.mk
## Generated on : Tue Sep 08 13:40:22 2026
## Final product: ./SpinningMode_rtwlib.lib
...
COMPILER_COMMAND_FILE     = SpinningMode_comp.rsp
CMD_FILE                  = SpinningMode.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = SpinningMode_rtwlib.lib
...
PRODUCT = ./SpinningMode_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=SpinningMode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/SpinningMode/SpinningMode.c
...
%.o : $(START_DIR)/slprj/ert/SpinningMode/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/SpinningMode/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/SpinningMode/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/SpinningMode/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/SpinningMode/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SpinningMode.o : $(START_DIR)/slprj/ert/SpinningMode/SpinningMode.c
	$(CC) $(CFLAGS) -o "$@" "$<"
