###########################################################################
## Makefile generated for component 'PHighCellTemperatureDerate'. 
## 
## Makefile     : PHighCellTemperatureDerate.mk
## Generated on : Tue Sep 08 13:38:17 2026
## Final product: ./PHighCellTemperatureDerate_rtwlib.lib
...
PRODUCT_NAME              = PHighCellTemperatureDerate
MAKEFILE                  = PHighCellTemperatureDerate.mk
...
COMPILER_COMMAND_FILE     = PHighCellTemperatureDerate_comp.rsp
CMD_FILE                  = PHighCellTemperatureDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PHighCellTemperatureDerate_rtwlib.lib
...
PRODUCT = ./PHighCellTemperatureDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PHighCellTemperatureDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/PHighCellTemperatureDerate.c
...
OBJS = PHighCellTemperatureDerate.o
...
%.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PHighCellTemperatureDerate.o : $(START_DIR)/slprj/ert/PHighCellTemperatureDerate/PHighCellTemperatureDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
