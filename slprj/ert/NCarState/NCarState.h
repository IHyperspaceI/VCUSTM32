 ...
 * C/C++ source code generated on : Wed Jun  3 14:53:56 2026
 *
...
typedef struct {
  real_T BReadyToDriveBuzzer;          /* '<Root>/NCarState Master System' */
  real_T BReadyToDrive;                /* '<Root>/NCarState Master System' */
} B_NCarState_c_T;

/* Block states (default storage) for model 'NCarState' */
typedef struct {
  uint16_T temporalCounter_i1;         /* '<Root>/NCarState Master System' */
  uint8_T is_active_c1_NCarState;      /* '<Root>/NCarState Master System' */
  uint8_T is_c1_NCarState;             /* '<Root>/NCarState Master System' */
  uint8_T is_Ready_To_Drive;           /* '<Root>/NCarState Master System' */
} DW_NCarState_f_T;
...
extern void NCarState(const boolean_T *rtu_BErrorReset, const real_T
                      *rtu_rThrottlePedal, const real_T *rtu_pBrakeF, const
                      ...
                      real_T *rtu_nMotorRL, const real_T *rtu_NInvState, const
                      boolean_T *rtu_BReadyToDriveButton, real_T *rty_NCarState,
                      boolean_T *rty_BReadyToDriveBuzzer, boolean_T
                      *rty_BReadyToDrive, B_NCarState_c_T *localB,
 ...
 *
 * '<Root>' : 'NCarState'
 * '<S1>'   : 'NCarState/NCarState Master System'
 */
#endif                                 /* NCarState_h_ */
