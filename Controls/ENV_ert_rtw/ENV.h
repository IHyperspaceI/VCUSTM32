 ...
 *
 * Model version                  : 13.285
 * Simulink Coder version         : 24.2 (R2024b) 21-Jun-2024
 * C/C++ source code generated on : Wed Sep 16 17:06:11 2026
 *
...
/* Block states (default storage) for system '<S59>/SPI Controller Transfer1' */
typedef struct {
  stm32cube_blocks_SPIControlle_T obj; /* '<S59>/SPI Controller Transfer1' */
  boolean_T objisempty;                /* '<S59>/SPI Controller Transfer1' */
} DW_SPIControllerTransfer1_fwu_T;

/* Block states (default storage) for system '<S59>/SPI Controller Transfer5' */
typedef struct {
  stm32cube_blocks_SPIControlle_T obj; /* '<S59>/SPI Controller Transfer5' */
  boolean_T objisempty;                /* '<S59>/SPI Controller Transfer5' */
...
/* Block states (default storage) for system '<S62>/SPI Controller Transfer5' */
typedef struct {
  stm32cube_blocks_SPIControlle_T obj; /* '<S62>/SPI Controller Transfer5' */
  boolean_T objisempty;                /* '<S62>/SPI Controller Transfer5' */
...
typedef struct {
  ...
  boolean_T OutportBufferForMCPInitialized;/* '<S61>/Constant' */
  boolean_T OutportBufferForMCPInitialize_k;/* '<S58>/Constant' */
...
typedef struct {
  ...
  stm32cube_blocks_SPIControlle_T obj_l;/* '<S59>/SPI Controller Transfer' */
  ...
  stm32cube_blocks_SPIControlle_T obj_o;/* '<S2>/SPI Controller Transfer6' */
  real_T UnitDelay5_DSTATE;            /* '<S15>/Unit Delay5' */
  real_T DelayInput1_DSTATE;           /* '<S57>/Delay Input1' */
  real_T UnitDelay5_DSTATE_g;          /* '<S16>/Unit Delay5' */
  real_T DelayInput1_DSTATE_e;         /* '<S60>/Delay Input1' */
  ...
  boolean_T UnitDelay5_DSTATE_p;       /* '<Root>/Unit Delay5' */
  DW_SPIControllerTransfer5_E_f_T SPIControllerTransfer7_pnaevv;/* '<S62>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer_fwu4_T SPIControllerTransfer6_pnae;/* '<S62>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer5_E_f_T SPIControllerTransfer5_pnae;/* '<S62>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer_fwu4_T SPIControllerTransfer4_pnae;/* '<S62>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer_fwu4_T SPIControllerTransfer3_pnae;/* '<S62>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer_fwu4_T SPIControllerTransfer2_pnae;/* '<S62>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer_fwu4_T SPIControllerTransfer1_pnae;/* '<S62>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer5_ENV_T SPIControllerTransfer7_pnaev;/* '<S59>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer1_fwu_T SPIControllerTransfer6_pna;/* '<S59>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer5_ENV_T SPIControllerTransfer5_pna;/* '<S59>/SPI Controller Transfer5' */
  DW_SPIControllerTransfer1_fwu_T SPIControllerTransfer4_pna;/* '<S59>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_fwu_T SPIControllerTransfer3_pna;/* '<S59>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_fwu_T SPIControllerTransfer2_pna;/* '<S59>/SPI Controller Transfer1' */
  DW_SPIControllerTransfer1_fwu_T SPIControllerTransfer1_pna;/* '<S59>/SPI Controller Transfer1' */
...
/* Invariant block signals for system '<S15>/Initialize' */
typedef struct {
  const boolean_T Constant;            /* '<S58>/Constant' */
...
typedef struct {
  ...
  ConstB_Initialize_ENV_T Initialize_f;/* '<S16>/Initialize' */
  ConstB_Initialize_ENV_T Initialize;  /* '<S15>/Initialize' */
} ConstB_ENV_T;
...
typedef struct {
   ...
   * Referenced by:
   *   '<S59>/ 000: normal mode, 0: don't abort pending transmit buffers, 0: one-shot disabled, 0: CLKOUT disabled, 00: sysclk//1 | 0000 0000 | 0x00'
 ...
 * Block '<S43>/FixPt Constant' : Unused code path elimination
 * Block '<S43>/FixPt Data Type Duplicate' : Unused code path elimination
 * Block '<S43>/FixPt Sum1' : Unused code path elimination
 * Block '<S8>/Output' : Unused code path elimination
 * Block '<S44>/Constant' : Unused code path elimination
 * Block '<S44>/FixPt Data Type Duplicate1' : Unused code path elimination
 * Block '<S44>/FixPt Switch' : Unused code path elimination
 ...
 * '<S15>'  : 'ENV/Initialize CAN3'
 * '<S16>'  : 'ENV/Initialize CAN5'
 * '<S17>'  : 'ENV/CAN Tx2/MATLAB Function'
 * '<S18>'  : 'ENV/CAN Tx2/MATLAB Function1'
 * '<S19>'  : 'ENV/CAN Tx2/MATLAB Function2'
 * '<S20>'  : 'ENV/CAN Tx2/MATLAB Function4'
 * '<S21>'  : 'ENV/CAN Tx3/MATLAB Function'
 * '<S22>'  : 'ENV/CAN Tx3/MATLAB Function1'
 * '<S23>'  : 'ENV/CAN Tx3/MATLAB Function2'
 * '<S24>'  : 'ENV/CAN Tx3/MATLAB Function4'
 * '<S25>'  : 'ENV/CAN1 RX/MATLAB Function1'
 * '<S26>'  : 'ENV/CAN1 RX/MATLAB Function2'
 * '<S27>'  : 'ENV/CAN1 RX/MATLAB Function3'
 * '<S28>'  : 'ENV/CAN1 RX/MATLAB Function4'
 * '<S29>'  : 'ENV/CAN1 RX/MATLAB Function5'
 * '<S30>'  : 'ENV/CAN1 RX/MATLAB Function6'
 * '<S31>'  : 'ENV/CAN1 RX/MATLAB Function7'
 * '<S32>'  : 'ENV/CAN1 RX/MATLAB Function8'
 * '<S33>'  : 'ENV/CAN2 RX/MATLAB Function1'
 * '<S34>'  : 'ENV/CAN2 RX/MATLAB Function2'
 * '<S35>'  : 'ENV/CAN2 RX/MATLAB Function3'
 * '<S36>'  : 'ENV/CAN2 RX/MATLAB Function4'
 * '<S37>'  : 'ENV/CAN2 RX/MATLAB Function5'
 * '<S38>'  : 'ENV/CAN2 RX/MATLAB Function6'
 * '<S39>'  : 'ENV/CAN2 RX/MATLAB Function7'
 * '<S40>'  : 'ENV/CAN2 RX/MATLAB Function8'
 * '<S41>'  : 'ENV/CAN3 RX/MATLAB Function7'
 * '<S42>'  : 'ENV/CAN4 RX/MATLAB Function7'
 * '<S43>'  : 'ENV/Counter Limited/Increment Real World'
 * '<S44>'  : 'ENV/Counter Limited/Wrap To Zero'
 * '<S45>'  : 'ENV/Digital Port Read1/ECSoC'
 * '<S46>'  : 'ENV/Digital Port Read1/ECSoC/ECSimCodegen'
 * '<S47>'  : 'ENV/Digital Port Read2/ECSoC'
 * '<S48>'  : 'ENV/Digital Port Read2/ECSoC/ECSimCodegen'
 * '<S49>'  : 'ENV/Digital Port Read3/ECSoC'
 * '<S50>'  : 'ENV/Digital Port Read3/ECSoC/ECSimCodegen'
 * '<S51>'  : 'ENV/Digital Port Read4/ECSoC'
 * '<S52>'  : 'ENV/Digital Port Read4/ECSoC/ECSimCodegen'
 * '<S53>'  : 'ENV/Digital Port Write/ECSoC'
 * '<S54>'  : 'ENV/Digital Port Write/ECSoC/ECSimCodegen'
 * '<S55>'  : 'ENV/Digital Port Write1/ECSoC'
 * '<S56>'  : 'ENV/Digital Port Write1/ECSoC/ECSimCodegen'
 * '<S57>'  : 'ENV/Initialize CAN3/Detect Increase'
 * '<S58>'  : 'ENV/Initialize CAN3/Initialize'
 * '<S59>'  : 'ENV/Initialize CAN3/MCPInit'
 * '<S60>'  : 'ENV/Initialize CAN5/Detect Increase'
 * '<S61>'  : 'ENV/Initialize CAN5/Initialize'
 * '<S62>'  : 'ENV/Initialize CAN5/MCPInit'
 */
#endif                                 /* ENV_h_ */
