...
{
  /* SystemInitialize for SignalConversion generated from: '<S58>/MCPInitialized' */
...
void ENV_Initialize(real_T rtu_Enable, boolean_T *rty_MCPInitialized, const
                    ConstB_Initialize_ENV_T *localC)
{
  /* Outputs for Enabled SubSystem: '<S15>/Initialize' incorporates:
   *  EnablePort: '<S58>/Enable'
   */
  if (rtu_Enable > 0.0) {
    /* SignalConversion generated from: '<S58>/MCPInitialized' */
    *rty_MCPInitialized = localC->Constant;
  }

  /* End of Outputs for SubSystem: '<S15>/Initialize' */
}
...
void E_SPIControllerTransfer1_n_Init(DW_SPIControllerTransfer1_fwu_T *localDW)
{
  ...
  /* Start for MATLABSystem: '<S59>/SPI Controller Transfer1' */
  localDW->obj.matlabCodegenIsDeleted = false;
  localDW->objisempty = true;
  localDW->obj.isInitialized = 1;
  b.PeripheralPtr = SPI1;
  ...
  DW_SPIControllerTransfer1_fwu_T *localDW)
{
  ...
  /* MATLABSystem: '<S59>/SPI Controller Transfer1' */
  status = MW_STM32_SPI_SetFormat(localDW->obj.MW_SPI_HANDLE, 0U, 1792U,
    MW_SPI_MODE_2);
  if (status == 0) {
    GPIO_TypeDef * portNameLoc;
  ...
  /* End of MATLABSystem: '<S59>/SPI Controller Transfer1' */
}

/* Termination for atomic system: */
void E_SPIControllerTransfer1_e_Term(DW_SPIControllerTransfer1_fwu_T *localDW)
{
  /* Terminate for MATLABSystem: '<S59>/SPI Controller Transfer1' */
  if (!localDW->obj.matlabCodegenIsDeleted) {
    localDW->obj.matlabCodegenIsDeleted = true;
    if ((localDW->obj.isInitialized == 1) && localDW->obj.isSetupComplete) {
      uint32_T SPIPinsLoc;
  ...
  /* End of Terminate for MATLABSystem: '<S59>/SPI Controller Transfer1' */
}
...
void ENV_SPIControllerTransfer5_Init(DW_SPIControllerTransfer5_ENV_T *localDW)
{
  ...
  /* Start for MATLABSystem: '<S59>/SPI Controller Transfer5' */
  localDW->obj.matlabCodegenIsDeleted = false;
  localDW->objisempty = true;
  localDW->obj.isInitialized = 1;
  b.PeripheralPtr = SPI1;
  ...
  DW_SPIControllerTransfer5_ENV_T *localDW)
{
  ...
  /* MATLABSystem: '<S59>/SPI Controller Transfer5' */
  status = MW_STM32_SPI_SetFormat(localDW->obj.MW_SPI_HANDLE, 0U, 1792U,
    MW_SPI_MODE_2);
  if (status == 0) {
    GPIO_TypeDef * portNameLoc;
  ...
  /* End of MATLABSystem: '<S59>/SPI Controller Transfer5' */
}

/* Termination for atomic system: */
void ENV_SPIControllerTransfer5_Term(DW_SPIControllerTransfer5_ENV_T *localDW)
{
  /* Terminate for MATLABSystem: '<S59>/SPI Controller Transfer5' */
  if (!localDW->obj.matlabCodegenIsDeleted) {
    localDW->obj.matlabCodegenIsDeleted = true;
    if ((localDW->obj.isInitialized == 1) && localDW->obj.isSetupComplete) {
      uint32_T SPIPinsLoc;
  ...
  /* End of Terminate for MATLABSystem: '<S59>/SPI Controller Transfer5' */
}
...
void E_SPIControllerTransfer5_o_Init(DW_SPIControllerTransfer5_E_f_T *localDW)
{
  ...
  /* Start for MATLABSystem: '<S62>/SPI Controller Transfer5' */
  localDW->obj.matlabCodegenIsDeleted = false;
  localDW->objisempty = true;
  localDW->obj.isInitialized = 1;
  b.PeripheralPtr = SPI1;
  ...
  DW_SPIControllerTransfer5_E_f_T *localDW)
{
  ...
  /* MATLABSystem: '<S62>/SPI Controller Transfer5' */
  status = MW_STM32_SPI_SetFormat(localDW->obj.MW_SPI_HANDLE, 0U, 1792U,
    MW_SPI_MODE_2);
  if (status == 0) {
    GPIO_TypeDef * portNameLoc;
  ...
  /* End of MATLABSystem: '<S62>/SPI Controller Transfer5' */
}

/* Termination for atomic system: */
void E_SPIControllerTransfer5_g_Term(DW_SPIControllerTransfer5_E_f_T *localDW)
{
  /* Terminate for MATLABSystem: '<S62>/SPI Controller Transfer5' */
  if (!localDW->obj.matlabCodegenIsDeleted) {
    localDW->obj.matlabCodegenIsDeleted = true;
    if ((localDW->obj.isInitialized == 1) && localDW->obj.isSetupComplete) {
      uint32_T SPIPinsLoc;
  ...
  /* End of Terminate for MATLABSystem: '<S62>/SPI Controller Transfer5' */
}
...
void ENV_step(void)
{
  ...
  /* Outputs for Enabled SubSystem: '<S15>/Initialize' */
  /* UnitDelay: '<S15>/Unit Delay5' */
  ENV_Initialize(ENV_DW.UnitDelay5_DSTATE,
                 &ENV_B.OutportBufferForMCPInitialize_k, &ENV_ConstB.Initialize);
  ...
  /* MATLABSystem: '<S46>/Digital Port Read' */
  ...
  ENV_MATLABFunction(ENV_B.CANPack4_e.ID, ENV_B.CANPack4_e.Length,
                     ...
                     ENV_DW.UnitDelay1_DSTATE, &rtb_VectorConcatenate3[0],
                     &rtb_VectorConcatenate3[2], &rtb_RTSByte,
                     &ENV_DW.sf_MATLABFunction4_e);
  ...
  ENV_MATLABFunction(ENV_ConstB.CANPack1_p.ID, ENV_ConstB.CANPack1_p.Length,
                     ...
                     ENV_DW.UnitDelay1_DSTATE, &rtb_VectorConcatenate_k[0],
                     &rtb_VectorConcatenate_k[2], &rtb_RTSByte,
                     &ENV_DW.sf_MATLABFunction_c);
  ...
  ENV_MATLABFunction(ENV_ConstB.CANPack2_g.ID, ENV_ConstB.CANPack2_g.Length,
                     ...
                     ENV_DW.UnitDelay1_DSTATE, &rtb_VectorConcatenate1_d[0],
                     &rtb_VectorConcatenate1_d[2], &rtb_RTSByte,
                     &ENV_DW.sf_MATLABFunction1_n);
  ...
  ENV_MATLABFunction(ENV_ConstB.CANPack3_g.ID, ENV_ConstB.CANPack3_g.Length,
                     ...
                     ENV_DW.UnitDelay1_DSTATE, &rtb_VectorConcatenate2_d[0],
                     &rtb_VectorConcatenate2_d[2], &rtb_RTSByte,
                     &ENV_DW.sf_MATLABFunction2_k);
   ...
   *  Constant: '<S59>/ 000: normal mode, 0: don't abort pending transmit buffers, 0: one-shot disabled, 0: CLKOUT disabled, 00: sysclk//1 | 0000 0000 | 0x00'
   *  Constant: '<S59>/CANINTE'
   *  Constant: '<S59>/CNF1'
   *  Constant: '<S59>/CNF2'
   *  Constant: '<S59>/CNF3'
   *  Constant: '<S59>/Clear flags'
   *  Constant: '<S59>/Set acceptance filters'
  ...
  if ((real_T)rtb_NOT1 > ENV_DW.DelayInput1_DSTATE) {
    /* MATLABSystem: '<S59>/SPI Controller Transfer' incorporates:
     *  Constant: '<S59>/Enter Configuration Mode'
     */
    ...
    /* End of MATLABSystem: '<S59>/SPI Controller Transfer' */
  ...
  /* End of RelationalOperator: '<S57>/FixPt Relational Operator' */
  /* End of Outputs for SubSystem: '<S15>/MCPInit' */

  /* UnitDelay: '<Root>/Unit Delay5' incorporates:
   *  UnitDelay: '<Root>/Unit Delay1'
   */
  ENV_DW.UnitDelay1_DSTATE = ENV_DW.UnitDelay5_DSTATE_p;

  /* Outputs for Enabled SubSystem: '<S16>/Initialize' */
  /* UnitDelay: '<S16>/Unit Delay5' */
  ENV_Initialize(ENV_DW.UnitDelay5_DSTATE_g,
                 &ENV_B.OutportBufferForMCPInitialized, &ENV_ConstB.Initialize_f);

  /* End of Outputs for SubSystem: '<S16>/Initialize' */

  /* MATLABSystem: '<S54>/Digital Port Write' */
  portNameLoc = GPIOB;
  if (ENV_B.OutportBufferForMCPInitialized) {
    c = 16;
  } else {
    c = 0;
  }
   ...
   *  UnitDelay: '<S16>/Unit Delay5'
   */
  ENV_DW.UnitDelay5_DSTATE_g = rtb_NOT1;
   ...
   *  Store in Global RAM
   */
  if ((real_T)rtb_NOT1 > ENV_DW.DelayInput1_DSTATE_e) {
  ...
  /* End of RelationalOperator: '<S60>/FixPt Relational Operator' */
   ...
   */
  ENV_DW.UnitDelay5_DSTATE_p = true;
   ...
   *  Store in Global RAM
   */
  ENV_DW.DelayInput1_DSTATE_e = rtb_NOT1;
...
{
  {
    ...
    /* SystemInitialize for Enabled SubSystem: '<S15>/Initialize' */
    ENV_Initialize_Init(&ENV_B.OutportBufferForMCPInitialize_k,
                        &ENV_ConstB.Initialize);

    /* End of SystemInitialize for SubSystem: '<S15>/Initialize' */
    ...
    /* Start for MATLABSystem: '<S59>/SPI Controller Transfer' */
    ...
    ENV_SPIControllerTransfer5_Init(&ENV_DW.SPIControllerTransfer7_pnaev);
    ...
    E_SPIControllerTransfer5_o_Init(&ENV_DW.SPIControllerTransfer5_pnae);
    E_SPIControllerTransfer1_j_Init(&ENV_DW.SPIControllerTransfer6_pnae);
    E_SPIControllerTransfer5_o_Init(&ENV_DW.SPIControllerTransfer7_pnaevv);
    ...
    b.PeripheralPtr = SPI1;
    ENV_DW.obj_o.MW_SPI_HANDLE = SPI_STM32_Init(&b);
...
void ENV_terminate(void)
{
  ...
  /* Terminate for MATLABSystem: '<S59>/SPI Controller Transfer' */
  ...
  /* End of Terminate for MATLABSystem: '<S59>/SPI Controller Transfer' */
  ...
  ENV_SPIControllerTransfer5_Term(&ENV_DW.SPIControllerTransfer7_pnaev);
  ...
  E_SPIControllerTransfer5_g_Term(&ENV_DW.SPIControllerTransfer5_pnae);
  E_SPIControllerTransfer1_k_Term(&ENV_DW.SPIControllerTransfer6_pnae);
  E_SPIControllerTransfer5_g_Term(&ENV_DW.SPIControllerTransfer7_pnaevv);
