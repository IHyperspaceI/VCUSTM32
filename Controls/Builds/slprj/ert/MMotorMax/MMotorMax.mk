###########################################################################
## Makefile generated for component 'MMotorMax'. 
## 
## Makefile     : MMotorMax.mk
## Generated on : Tue Sep 08 13:39:19 2026
## Final product: ./MMotorMax_rtwlib.lib
...
COMPILER_COMMAND_FILE     = MMotorMax_comp.rsp
CMD_FILE                  = MMotorMax.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MMotorMax_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MMotorMax -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MMotorMax/MMotorMax.c
...
%.o : $(START_DIR)/slprj/ert/MMotorMax/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MMotorMax/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MMotorMax/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MMotorMax/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MMotorMax/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MMotorMax.o : $(START_DIR)/slprj/ert/MMotorMax/MMotorMax.c
	$(CC) $(CFLAGS) -o "$@" "$<"
