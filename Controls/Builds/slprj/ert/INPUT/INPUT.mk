###########################################################################
## Makefile generated for component 'INPUT'. 
## 
## Makefile     : INPUT.mk
## Generated on : Tue Sep 08 13:40:44 2026
## Final product: ./INPUT_rtwlib.lib
...
MODELREF_LINK_RSPFILE     = INPUT_ref.rsp
COMPILER_COMMAND_FILE     = INPUT_comp.rsp
CMD_FILE                  = INPUT.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = INPUT_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=INPUT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/INPUT/INPUT.c
...
MODELREF_LIBS = ../../../slprj/ert/BMSInputs/BMSInputs_rtwlib.lib ../../../slprj/ert/GPSIMUInputs/GPSIMUInputs_rtwlib.lib ../../../slprj/ert/InverterInputs/InverterInputs_rtwlib.lib ../../../slprj/ert/SensorInputs/SensorInputs_rtwlib.lib ../../../slprj/ert/WheelSpeedInputs/WheelSpeedInputs_rtwlib.lib
...
%.o : $(START_DIR)/slprj/ert/INPUT/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/INPUT/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/INPUT/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/INPUT/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/INPUT/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
INPUT.o : $(START_DIR)/slprj/ert/INPUT/INPUT.c
	$(CC) $(CFLAGS) -o "$@" "$<"
