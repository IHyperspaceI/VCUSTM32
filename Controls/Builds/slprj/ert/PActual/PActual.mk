###########################################################################
## Makefile generated for component 'PActual'. 
## 
## Makefile     : PActual.mk
## Generated on : Tue Sep 08 13:39:22 2026
## Final product: ./PActual_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PActual_comp.rsp
CMD_FILE                  = PActual.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PActual_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PActual -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PActual/PActual.c
...
%.o : $(START_DIR)/slprj/ert/PActual/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PActual/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PActual/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PActual/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PActual/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PActual.o : $(START_DIR)/slprj/ert/PActual/PActual.c
	$(CC) $(CFLAGS) -o "$@" "$<"
