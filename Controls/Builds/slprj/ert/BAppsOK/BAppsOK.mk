###########################################################################
## Makefile generated for component 'BAppsOK'. 
## 
## Makefile     : BAppsOK.mk
## Generated on : Tue Sep 08 13:38:50 2026
## Final product: ./BAppsOK_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BAppsOK_comp.rsp
CMD_FILE                  = BAppsOK.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BAppsOK_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BAppsOK -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BAppsOK/BAppsOK.c
...
%.o : $(START_DIR)/slprj/ert/BAppsOK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BAppsOK/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BAppsOK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BAppsOK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BAppsOK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BAppsOK.o : $(START_DIR)/slprj/ert/BAppsOK/BAppsOK.c
	$(CC) $(CFLAGS) -o "$@" "$<"
