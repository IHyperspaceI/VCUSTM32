###########################################################################
## Makefile generated for component 'BThrottleError'. 
## 
## Makefile     : BThrottleError.mk
## Generated on : Tue Sep 08 13:39:16 2026
## Final product: ./BThrottleError_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BThrottleError_comp.rsp
CMD_FILE                  = BThrottleError.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BThrottleError_rtwlib.lib
...
PRODUCT = ./BThrottleError_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BThrottleError -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BThrottleError/BThrottleError.c
...
%.o : $(START_DIR)/slprj/ert/BThrottleError/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BThrottleError/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BThrottleError/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BThrottleError/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BThrottleError/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BThrottleError.o : $(START_DIR)/slprj/ert/BThrottleError/BThrottleError.c
	$(CC) $(CFLAGS) -o "$@" "$<"
