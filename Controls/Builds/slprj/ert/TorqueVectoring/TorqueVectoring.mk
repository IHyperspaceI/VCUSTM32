...
## Generated on : Tue Sep 08 13:40:33 2026
## Final product: ./TorqueVectoring_rtwlib.lib
...
COMPILER_COMMAND_FILE     = TorqueVectoring_comp.rsp
CMD_FILE                  = TorqueVectoring.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TorqueVectoring_rtwlib.lib
...
PRODUCT = ./TorqueVectoring_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/TorqueVectoring/TorqueVectoring.c $(START_DIR)/slprj/ert/TorqueVectoring/TorqueVectoring_data.c
...
OBJS = TorqueVectoring.o TorqueVectoring_data.o
...
%.o : $(START_DIR)/slprj/ert/TorqueVectoring/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TorqueVectoring/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TorqueVectoring/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TorqueVectoring/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TorqueVectoring/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TorqueVectoring.o : $(START_DIR)/slprj/ert/TorqueVectoring/TorqueVectoring.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TorqueVectoring_data.o : $(START_DIR)/slprj/ert/TorqueVectoring/TorqueVectoring_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
