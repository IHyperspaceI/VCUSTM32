###########################################################################
## Makefile generated for component 'NCarState'. 
## 
## Makefile     : NCarState.mk
## Generated on : Tue Sep 08 13:38:42 2026
## Final product: ./NCarState_rtwlib.lib
...
COMPILER_COMMAND_FILE     = NCarState_comp.rsp
CMD_FILE                  = NCarState.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = NCarState_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=NCarState -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/NCarState/NCarState.c
...
%.o : $(START_DIR)/slprj/ert/NCarState/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NCarState/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NCarState/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NCarState/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NCarState/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NCarState.o : $(START_DIR)/slprj/ert/NCarState/NCarState.c
	$(CC) $(CFLAGS) -o "$@" "$<"
