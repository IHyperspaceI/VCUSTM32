###########################################################################
## Makefile generated for component 'PRegenDerate'. 
## 
## Makefile     : PRegenDerate.mk
## Generated on : Tue Sep 08 13:38:25 2026
## Final product: ./PRegenDerate_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PRegenDerate_comp.rsp
CMD_FILE                  = PRegenDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PRegenDerate_rtwlib.lib
...
PRODUCT = ./PRegenDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PRegenDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PRegenDerate/PRegenDerate.c
...
%.o : $(START_DIR)/slprj/ert/PRegenDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PRegenDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PRegenDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PRegenDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PRegenDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PRegenDerate.o : $(START_DIR)/slprj/ert/PRegenDerate/PRegenDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
