###########################################################################
## Makefile generated for component 'NBMSState'. 
## 
## Makefile     : NBMSState.mk
## Generated on : Tue Sep 08 13:38:38 2026
## Final product: ./NBMSState_rtwlib.lib
...
COMPILER_COMMAND_FILE     = NBMSState_comp.rsp
CMD_FILE                  = NBMSState.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = NBMSState_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=NBMSState -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/NBMSState/NBMSState.c
...
%.o : $(START_DIR)/slprj/ert/NBMSState/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NBMSState/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NBMSState/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NBMSState/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NBMSState/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NBMSState.o : $(START_DIR)/slprj/ert/NBMSState/NBMSState.c
	$(CC) $(CFLAGS) -o "$@" "$<"
