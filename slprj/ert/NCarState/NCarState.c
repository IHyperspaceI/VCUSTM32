...
/* Named constants for Chart: '<Root>/NCarState Master System' */
...
void NCarState(const boolean_T *rtu_BErrorReset, const real_T
               ...
               *rtu_nMotorRL, const real_T *rtu_NInvState, const boolean_T
               *rtu_BReadyToDriveButton, real_T *rty_NCarState, boolean_T
               *rty_BReadyToDriveBuzzer, boolean_T *rty_BReadyToDrive,
               B_NCarState_c_T *localB, DW_NCarState_f_T *localDW)
{
  /* Chart: '<Root>/NCarState Master System' */
  ...
  /* End of Chart: '<Root>/NCarState Master System' */
