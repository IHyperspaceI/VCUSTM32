###########################################################################
## Makefile generated for component 'LIMITATIONS'. 
## 
## Makefile     : LIMITATIONS.mk
## Generated on : Tue Sep 08 13:40:51 2026
## Final product: ./LIMITATIONS_rtwlib.lib
...
MODELREF_LINK_RSPFILE     = LIMITATIONS_ref.rsp
COMPILER_COMMAND_FILE     = LIMITATIONS_comp.rsp
CMD_FILE                  = LIMITATIONS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = LIMITATIONS_rtwlib.lib
...
PRODUCT = ./LIMITATIONS_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=LIMITATIONS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/LIMITATIONS/LIMITATIONS.c
...
MODELREF_LIBS = ../../../slprj/ert/BAllowTorque/BAllowTorque_rtwlib.lib ../../../slprj/ert/PCellVoltageDerate/PCellVoltageDerate_rtwlib.lib ../../../slprj/ert/PDischargeDerate/PDischargeDerate_rtwlib.lib ../../../slprj/ert/PHighCellTemperatureDerate/PHighCellTemperatureDerate_rtwlib.lib ../../../slprj/ert/PInvTemperatureDerate/PInvTemperatureDerate_rtwlib.lib ../../../slprj/ert/PMotorTemperatureDerate/PMotorTemperatureDerate_rtwlib.lib ../../../slprj/ert/PRegenDerate/PRegenDerate_rtwlib.lib ../../../slprj/ert/PSOCDerate/PSOCDerate_rtwlib.lib ../../../slprj/ert/PTSTemperatureDerate/PTSTemperatureDerate_rtwlib.lib ../../../slprj/ert/rSpeedRegenDerate/rSpeedRegenDerate_rtwlib.lib
...
%.o : $(START_DIR)/slprj/ert/LIMITATIONS/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/LIMITATIONS/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/LIMITATIONS/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/LIMITATIONS/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/LIMITATIONS/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LIMITATIONS.o : $(START_DIR)/slprj/ert/LIMITATIONS/LIMITATIONS.c
	$(CC) $(CFLAGS) -o "$@" "$<"
