###########################################################################
## Makefile generated for component 'PTSTemperatureDerate'. 
## 
## Makefile     : PTSTemperatureDerate.mk
## Generated on : Tue Sep 08 13:38:31 2026
## Final product: ./PTSTemperatureDerate_rtwlib.lib
...
PRODUCT_NAME              = PTSTemperatureDerate
MAKEFILE                  = PTSTemperatureDerate.mk
...
COMPILER_COMMAND_FILE     = PTSTemperatureDerate_comp.rsp
CMD_FILE                  = PTSTemperatureDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PTSTemperatureDerate_rtwlib.lib
...
PRODUCT = ./PTSTemperatureDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PTSTemperatureDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PTSTemperatureDerate/PTSTemperatureDerate.c
...
%.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PTSTemperatureDerate.o : $(START_DIR)/slprj/ert/PTSTemperatureDerate/PTSTemperatureDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
