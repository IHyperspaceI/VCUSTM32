###########################################################################
## Makefile generated for component 'BInverterError'. 
## 
## Makefile     : BInverterError.mk
## Generated on : Tue Sep 08 13:39:08 2026
## Final product: ./BInverterError_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BInverterError_comp.rsp
CMD_FILE                  = BInverterError.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BInverterError_rtwlib.lib
...
PRODUCT = ./BInverterError_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BInverterError -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BInverterError/BInverterError.c
...
%.o : $(START_DIR)/slprj/ert/BInverterError/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BInverterError/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BInverterError/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BInverterError/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BInverterError/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BInverterError.o : $(START_DIR)/slprj/ert/BInverterError/BInverterError.c
	$(CC) $(CFLAGS) -o "$@" "$<"
