###########################################################################
## Makefile generated for component 'vChassis'. 
## 
## Makefile     : vChassis.mk
## Generated on : Tue Sep 08 13:39:56 2026
## Final product: ./vChassis_rtwlib.lib
...
COMPILER_COMMAND_FILE     = vChassis_comp.rsp
CMD_FILE                  = vChassis.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = vChassis_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=vChassis -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/vChassis/vChassis.c
...
%.o : $(START_DIR)/slprj/ert/vChassis/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/vChassis/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/vChassis/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/vChassis/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/vChassis/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
vChassis.o : $(START_DIR)/slprj/ert/vChassis/vChassis.c
	$(CC) $(CFLAGS) -o "$@" "$<"
