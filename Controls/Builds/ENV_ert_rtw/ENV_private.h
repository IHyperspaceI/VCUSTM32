...
extern void E_SPIControllerTransfer1_i_Init(DW_SPIControllerTransfer1_E_f_T
  *localDW);
extern void ENV_SPIControllerTransfer1_p(const uint8_T rtu_0[3],
...
extern void E_SPIControllerTransfer5_o_Init(DW_SPIControllerTransfer5_E_f_T
  *localDW);
extern void ENV_SPIControllerTransfer5_p(const uint8_T rtu_0[4],
...
extern void E_SPIControllerTransfer5_c_Init(DW_SPIControllerTransfer5_fw_T
  *localDW);
extern void ENV_SPIControllerTransfer5_pn(const uint8_T rtu_0[4],
...
extern void E_SPIControllerTransfer5_l_Init(DW_SPIControllerTransfer5_fwu_T
  *localDW);
extern void ENV_SPIControllerTransfer5_pna(const uint8_T rtu_0[4],
...
extern void E_SPIControllerTransfer1_d_Term(DW_SPIControllerTransfer1_fw_T
  *localDW);
extern void E_SPIControllerTransfer5_g_Term(DW_SPIControllerTransfer5_E_f_T
  *localDW);
extern void E_SPIControllerTransfer1_e_Term(DW_SPIControllerTransfer1_fwu_T
  *localDW);
extern void E_SPIControllerTransfer5_p_Term(DW_SPIControllerTransfer5_fw_T
  *localDW);
extern void E_SPIControllerTransfer1_k_Term(DW_SPIControllerTransfer_fwu4_T
  *localDW);
extern void E_SPIControllerTransfer5_c_Term(DW_SPIControllerTransfer5_fwu_T
  *localDW);
