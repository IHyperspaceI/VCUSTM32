###########################################################################
## Makefile generated for component 'BBrakeError'. 
## 
## Makefile     : BBrakeError.mk
## Generated on : Tue Sep 08 13:38:53 2026
## Final product: ./BBrakeError_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BBrakeError_comp.rsp
CMD_FILE                  = BBrakeError.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BBrakeError_rtwlib.lib
...
PRODUCT = ./BBrakeError_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BBrakeError -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BBrakeError/BBrakeError.c
...
%.o : $(START_DIR)/slprj/ert/BBrakeError/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BBrakeError/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BBrakeError/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BBrakeError/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BBrakeError/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BBrakeError.o : $(START_DIR)/slprj/ert/BBrakeError/BBrakeError.c
	$(CC) $(CFLAGS) -o "$@" "$<"
