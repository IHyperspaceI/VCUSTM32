###########################################################################
## Makefile generated for component 'rSOC'. 
## 
## Makefile     : rSOC.mk
## Generated on : Tue Sep 08 13:39:47 2026
## Final product: ./rSOC_rtwlib.lib
...
COMPILER_COMMAND_FILE     = rSOC_comp.rsp
CMD_FILE                  = rSOC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = rSOC_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=rSOC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/rSOC/rSOC.c
...
%.o : $(START_DIR)/slprj/ert/rSOC/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/rSOC/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/rSOC/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/rSOC/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/rSOC/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rSOC.o : $(START_DIR)/slprj/ert/rSOC/rSOC.c
	$(CC) $(CFLAGS) -o "$@" "$<"
