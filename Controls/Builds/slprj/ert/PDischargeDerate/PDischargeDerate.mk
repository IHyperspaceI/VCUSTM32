###########################################################################
## Makefile generated for component 'PDischargeDerate'. 
## 
## Makefile     : PDischargeDerate.mk
## Generated on : Tue Sep 08 13:38:14 2026
## Final product: ./PDischargeDerate_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PDischargeDerate_comp.rsp
CMD_FILE                  = PDischargeDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PDischargeDerate_rtwlib.lib
...
PRODUCT = ./PDischargeDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PDischargeDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PDischargeDerate/PDischargeDerate.c
...
%.o : $(START_DIR)/slprj/ert/PDischargeDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PDischargeDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PDischargeDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PDischargeDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PDischargeDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PDischargeDerate.o : $(START_DIR)/slprj/ert/PDischargeDerate/PDischargeDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
