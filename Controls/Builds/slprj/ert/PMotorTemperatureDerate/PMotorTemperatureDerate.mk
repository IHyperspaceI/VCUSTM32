###########################################################################
## Makefile generated for component 'PMotorTemperatureDerate'. 
## 
## Makefile     : PMotorTemperatureDerate.mk
## Generated on : Tue Sep 08 13:38:22 2026
## Final product: ./PMotorTemperatureDerate_rtwlib.lib
...
PRODUCT_NAME              = PMotorTemperatureDerate
MAKEFILE                  = PMotorTemperatureDerate.mk
...
COMPILER_COMMAND_FILE     = PMotorTemperatureDerate_comp.rsp
CMD_FILE                  = PMotorTemperatureDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PMotorTemperatureDerate_rtwlib.lib
...
PRODUCT = ./PMotorTemperatureDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PMotorTemperatureDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PMotorTemperatureDerate/PMotorTemperatureDerate.c
...
OBJS = PMotorTemperatureDerate.o
...
%.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PMotorTemperatureDerate.o : $(START_DIR)/slprj/ert/PMotorTemperatureDerate/PMotorTemperatureDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
