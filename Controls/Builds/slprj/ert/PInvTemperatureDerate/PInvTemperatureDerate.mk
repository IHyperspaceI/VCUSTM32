###########################################################################
## Makefile generated for component 'PInvTemperatureDerate'. 
## 
## Makefile     : PInvTemperatureDerate.mk
## Generated on : Tue Sep 08 13:38:20 2026
## Final product: ./PInvTemperatureDerate_rtwlib.lib
...
PRODUCT_NAME              = PInvTemperatureDerate
MAKEFILE                  = PInvTemperatureDerate.mk
...
COMPILER_COMMAND_FILE     = PInvTemperatureDerate_comp.rsp
CMD_FILE                  = PInvTemperatureDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PInvTemperatureDerate_rtwlib.lib
...
PRODUCT = ./PInvTemperatureDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PInvTemperatureDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PInvTemperatureDerate/PInvTemperatureDerate.c
...
%.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PInvTemperatureDerate.o : $(START_DIR)/slprj/ert/PInvTemperatureDerate/PInvTemperatureDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
