###########################################################################
## Makefile generated for component 'MDriverDischargeRequested'. 
## 
## Makefile     : MDriverDischargeRequested.mk
## Generated on : Tue Sep 08 13:40:05 2026
## Final product: ./MDriverDischargeRequested_rtwlib.lib
...
PRODUCT_NAME              = MDriverDischargeRequested
MAKEFILE                  = MDriverDischargeRequested.mk
...
COMPILER_COMMAND_FILE     = MDriverDischargeRequested_comp.rsp
CMD_FILE                  = MDriverDischargeRequested.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MDriverDischargeRequested_rtwlib.lib
...
PRODUCT = ./MDriverDischargeRequested_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MDriverDischargeRequested -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MDriverDischargeRequested/MDriverDischargeRequested.c
...
OBJS = MDriverDischargeRequested.o
...
%.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MDriverDischargeRequested.o : $(START_DIR)/slprj/ert/MDriverDischargeRequested/MDriverDischargeRequested.c
	$(CC) $(CFLAGS) -o "$@" "$<"
