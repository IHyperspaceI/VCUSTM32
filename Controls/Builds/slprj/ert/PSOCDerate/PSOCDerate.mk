###########################################################################
## Makefile generated for component 'PSOCDerate'. 
## 
## Makefile     : PSOCDerate.mk
## Generated on : Tue Sep 08 13:38:28 2026
## Final product: ./PSOCDerate_rtwlib.lib
...
COMPILER_COMMAND_FILE     = PSOCDerate_comp.rsp
CMD_FILE                  = PSOCDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = PSOCDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=PSOCDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/PSOCDerate/PSOCDerate.c
...
%.o : $(START_DIR)/slprj/ert/PSOCDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PSOCDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PSOCDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/PSOCDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/PSOCDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PSOCDerate.o : $(START_DIR)/slprj/ert/PSOCDerate/PSOCDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
