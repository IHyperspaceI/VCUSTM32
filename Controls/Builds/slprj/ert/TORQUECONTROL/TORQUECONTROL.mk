###########################################################################
## Makefile generated for component 'TORQUECONTROL'. 
## 
## Makefile     : TORQUECONTROL.mk
## Generated on : Tue Sep 08 13:41:12 2026
## Final product: ./TORQUECONTROL_rtwlib.lib
...
MODELREF_LINK_RSPFILE     = TORQUECONTROL_ref.rsp
COMPILER_COMMAND_FILE     = TORQUECONTROL_comp.rsp
CMD_FILE                  = TORQUECONTROL.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TORQUECONTROL_rtwlib.lib
...
PRODUCT = ./TORQUECONTROL_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=TORQUECONTROL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/TORQUECONTROL/TORQUECONTROL.c
...
MODELREF_LIBS = ../../../slprj/ert/EMS/EMS_rtwlib.lib ../../../slprj/ert/MDriverDischargeRequested/MDriverDischargeRequested_rtwlib.lib ../../../slprj/ert/MDriverRegenRequested/MDriverRegenRequested_rtwlib.lib ../../../slprj/ert/MFinal/MFinal_rtwlib.lib ../../../slprj/ert/MTotalRequested/MTotalRequested_rtwlib.lib ../../../slprj/ert/PowerController/PowerController_rtwlib.lib ../../../slprj/ert/SpinningMode/SpinningMode_rtwlib.lib ../../../slprj/ert/StateEstimation/StateEstimation_rtwlib.lib ../../../slprj/ert/TorqueDistribution/TorqueDistribution_rtwlib.lib ../../../slprj/ert/TorqueVectoring/TorqueVectoring_rtwlib.lib ../../../slprj/ert/TractionControl/TractionControl_rtwlib.lib
...
%.o : $(START_DIR)/slprj/ert/TORQUECONTROL/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TORQUECONTROL/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TORQUECONTROL/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/TORQUECONTROL/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/TORQUECONTROL/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TORQUECONTROL.o : $(START_DIR)/slprj/ert/TORQUECONTROL/TORQUECONTROL.c
	$(CC) $(CFLAGS) -o "$@" "$<"
