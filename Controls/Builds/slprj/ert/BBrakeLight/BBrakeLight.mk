###########################################################################
## Makefile generated for component 'BBrakeLight'. 
## 
## Makefile     : BBrakeLight.mk
## Generated on : Tue Sep 08 13:38:55 2026
## Final product: ./BBrakeLight_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BBrakeLight_comp.rsp
CMD_FILE                  = BBrakeLight.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BBrakeLight_rtwlib.lib
...
PRODUCT = ./BBrakeLight_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BBrakeLight -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BBrakeLight/BBrakeLight.c
...
%.o : $(START_DIR)/slprj/ert/BBrakeLight/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BBrakeLight/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BBrakeLight/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BBrakeLight/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BBrakeLight/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BBrakeLight.o : $(START_DIR)/slprj/ert/BBrakeLight/BBrakeLight.c
	$(CC) $(CFLAGS) -o "$@" "$<"
