###########################################################################
## Makefile generated for component 'BDrivetrainCoolingOn'. 
## 
## Makefile     : BDrivetrainCoolingOn.mk
## Generated on : Tue Sep 08 13:39:01 2026
## Final product: ./BDrivetrainCoolingOn_rtwlib.lib
...
PRODUCT_NAME              = BDrivetrainCoolingOn
MAKEFILE                  = BDrivetrainCoolingOn.mk
...
COMPILER_COMMAND_FILE     = BDrivetrainCoolingOn_comp.rsp
CMD_FILE                  = BDrivetrainCoolingOn.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BDrivetrainCoolingOn_rtwlib.lib
...
PRODUCT = ./BDrivetrainCoolingOn_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BDrivetrainCoolingOn -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/BDrivetrainCoolingOn.c
...
%.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BDrivetrainCoolingOn.o : $(START_DIR)/slprj/ert/BDrivetrainCoolingOn/BDrivetrainCoolingOn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
