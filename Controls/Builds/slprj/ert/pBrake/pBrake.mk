###########################################################################
## Makefile generated for component 'pBrake'. 
## 
## Makefile     : pBrake.mk
## Generated on : Tue Sep 08 13:39:41 2026
## Final product: ./pBrake_rtwlib.lib
...
COMPILER_COMMAND_FILE     = pBrake_comp.rsp
CMD_FILE                  = pBrake.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = pBrake_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=pBrake -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/pBrake/pBrake.c
...
%.o : $(START_DIR)/slprj/ert/pBrake/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/pBrake/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/pBrake/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/pBrake/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/pBrake/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
pBrake.o : $(START_DIR)/slprj/ert/pBrake/pBrake.c
	$(CC) $(CFLAGS) -o "$@" "$<"
