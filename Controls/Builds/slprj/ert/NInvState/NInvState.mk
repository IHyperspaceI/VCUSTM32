###########################################################################
## Makefile generated for component 'NInvState'. 
## 
## Makefile     : NInvState.mk
## Generated on : Tue Sep 08 13:38:46 2026
## Final product: ./NInvState_rtwlib.lib
...
COMPILER_COMMAND_FILE     = NInvState_comp.rsp
CMD_FILE                  = NInvState.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = NInvState_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=NInvState -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/NInvState/NInvState.c
...
%.o : $(START_DIR)/slprj/ert/NInvState/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NInvState/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NInvState/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/NInvState/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/NInvState/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NInvState.o : $(START_DIR)/slprj/ert/NInvState/NInvState.c
	$(CC) $(CFLAGS) -o "$@" "$<"
