###########################################################################
## Makefile generated for component 'MDriverRegenRequested'. 
## 
## Makefile     : MDriverRegenRequested.mk
## Generated on : Tue Sep 08 13:40:09 2026
## Final product: ./MDriverRegenRequested_rtwlib.lib
...
PRODUCT_NAME              = MDriverRegenRequested
MAKEFILE                  = MDriverRegenRequested.mk
...
COMPILER_COMMAND_FILE     = MDriverRegenRequested_comp.rsp
CMD_FILE                  = MDriverRegenRequested.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MDriverRegenRequested_rtwlib.lib
...
PRODUCT = ./MDriverRegenRequested_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MDriverRegenRequested -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MDriverRegenRequested/MDriverRegenRequested.c
...
%.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MDriverRegenRequested.o : $(START_DIR)/slprj/ert/MDriverRegenRequested/MDriverRegenRequested.c
	$(CC) $(CFLAGS) -o "$@" "$<"
