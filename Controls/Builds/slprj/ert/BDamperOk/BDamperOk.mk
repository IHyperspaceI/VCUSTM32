###########################################################################
## Makefile generated for component 'BDamperOk'. 
## 
## Makefile     : BDamperOk.mk
## Generated on : Tue Sep 08 13:38:58 2026
## Final product: ./BDamperOk_rtwlib.lib
...
COMPILER_COMMAND_FILE     = BDamperOk_comp.rsp
CMD_FILE                  = BDamperOk.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BDamperOk_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=BDamperOk -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/BDamperOk/BDamperOk.c
...
%.o : $(START_DIR)/slprj/ert/BDamperOk/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BDamperOk/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BDamperOk/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/BDamperOk/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/BDamperOk/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BDamperOk.o : $(START_DIR)/slprj/ert/BDamperOk/BDamperOk.c
	$(CC) $(CFLAGS) -o "$@" "$<"
