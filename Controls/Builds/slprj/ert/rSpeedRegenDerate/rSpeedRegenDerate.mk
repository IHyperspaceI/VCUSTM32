###########################################################################
## Makefile generated for component 'rSpeedRegenDerate'. 
## 
## Makefile     : rSpeedRegenDerate.mk
## Generated on : Tue Sep 08 13:38:34 2026
## Final product: ./rSpeedRegenDerate_rtwlib.lib
...
PRODUCT_NAME              = rSpeedRegenDerate
MAKEFILE                  = rSpeedRegenDerate.mk
...
COMPILER_COMMAND_FILE     = rSpeedRegenDerate_comp.rsp
CMD_FILE                  = rSpeedRegenDerate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = rSpeedRegenDerate_rtwlib.lib
...
PRODUCT = ./rSpeedRegenDerate_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=rSpeedRegenDerate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/rSpeedRegenDerate/rSpeedRegenDerate.c
...
%.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rSpeedRegenDerate.o : $(START_DIR)/slprj/ert/rSpeedRegenDerate/rSpeedRegenDerate.c
	$(CC) $(CFLAGS) -o "$@" "$<"
